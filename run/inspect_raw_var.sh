...
#SBATCH --output=/path/to/iHBCAv1_upload/logs/inspect_raw_var_%j.out
#SBATCH --error=/path/to/iHBCAv1_upload/logs/inspect_raw_var_%j.err
...
INTEGRATED="$REPO/outputs/integrated_objects/all-breast-cells.h5ad"
SKETCH="$REPO/outputs/integrated_objects/sketch.h5ad"
